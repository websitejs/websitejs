...
(function($, viewport) {
    ...
    /**
     * Shimano Bikegear Storelocator.
     * @class BikegearStoreLocator
     ...
     */
    var BikegearStoreLocator = function($element, options) {
    ...
    $.extend(BikegearStoreLocator.prototype, StoreLocatorBase.prototype, /** @lends BikegearStoreLocator.prototype */ {
...
//         }
    ...
    window['BikegearStoreLocator'] = BikegearStoreLocator;

    // The component registers itself to the componentHandler in the global scope.
    ComponentHandler.register({
        constructor: BikegearStoreLocator,
        classAsString: 'BikegearStoreLocator',
        cssClass: 'js-storelocator-bikegear'
    });
